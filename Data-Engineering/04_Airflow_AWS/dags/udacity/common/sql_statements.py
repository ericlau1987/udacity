...
#     "trips",
#     f"s3://{s3_bucket}/data-pipelines/divvy/partitioned/{year}/{month}/divvy_trips.csv"
# )

COPY_ALL_TRIPS_SQL = COPY_SQL.format(
    "trips",
    f"s3://{s3_bucket}/data-pipelines/divvy/unpartitioned/divvy_trips_2018.csv"
)

COPY_STATIONS_SQL = COPY_SQL.format(
    "stations",
    f"s3://{s3_bucket}/data-pipelines/divvy/unpartitioned/divvy_stations_2017.csv"
)
